...
const xmin = -117041.955909;
const xmax = 1130346.1429;
const ymin = 6039387.6153;
const ymax = 7222859.9602;
...
/*const bounds= [
 [6039387.6153 , -117041.955909],
 [6039387.6153 , 1130346.1429],
 [7222859.9602 , 1130346.1429],
 [7222859.9602 , -117041.955909],
 [6039387.6153 , -117041.955909] ] ;  */
 

const bounds = [
    [47.402865555, -0.307378173],   // SW
    [47.402865555, 10.140762498],   // SE
    [53.964825023, 10.140762498],   // NE
    [53.964825023, -0.307378173],   // NW
    [47.402865555, -0.307378173]    // fermeture
];

//L.polyline(bounds, {   color: "red",   weight: 3}).addTo(map);
...
function setOpacity(alpha){
    window.display.opacity = alpha;
    if(window.activeSprite)    {
        window.activeSprite.alpha = alpha;
    }
}
...
//console.log(layer_name ,  date) ; 
    ...
    //console.log(georaster.xmax - georaster.xmin ) ;  
    //console.log(georaster.ymax - georaster.ymin ); 
    //console.log(  georaster.pixelWidth) ;  
    //console.log(  georaster.pixelHeight );     
...
// Overlay  
document.querySelectorAll(".overlay-checkbox")
    .forEach(cb =>
    {
...
function showMSLP(){
	...
	//geoserverUrl ='http://192.168.15.194:8080/geoserver/behra_surf/wms?service=WMS&version=1.1.0&request=GetMap&layers=behra_surf:sfcgeo&bbox=-117041.95590912925,6037813.688007302,1130752.8531335457,7222873.349655833&width=768&height=729&srs=EPSG:3857&styles=sfcgeo_style&format=image/png&date=("2019-01-02T00:00:00.000Z")';
	//u = 'http://192.168.15.194:8080/geoserver/behra_surf/wms?service=WMS&version=1.1.0&request=GetMap&layers=behra_surf:sfcgeo&bbox=-117041.95590912925,6037813.688007302,1130752.8531335457,7222873.349655833&width=768&height=729&srs=EPSG:3857&styles=sfcgeo_style&format=image/png&date=("2019-01-02T00:00:00.000Z")'  ; 
    //console.log( u )   ;
    if (!overlays.mslp)    {
     mslp = L.tileLayer.wms( geoserverUrl 	, {
            layers: "behra_surf:sfcgeo",
            transparent: true,
            format: "image/png",
            //opacity:0.9 ,
            //version:"1.1.0"
...
{
    const mslp   = document.getElementById("overlay-mslp").checked;
